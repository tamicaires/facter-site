...
export function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative bg-gradient-to-b from-primary/90 to-primary/70">
        <div className="absolute inset-0 bg-grid-white/10" />
        <div className="container relative px-4 py-24 md:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col space-y-4">
              <Badge className="w-fit bg-background/20 text-background hover:bg-background/30" variant="secondary">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="bg-background text-primary hover:bg-background/90 gap-2">
            ...
            <div className="relative h-[600px]">
              <FloatingCards />
              <div className="relative h-full w-full overflow-hidden rounded-lg border bg-background/10 backdrop-blur-sm shadow-xl">
                <div className="absolute top-4 right-4 z-10">
                  <Card className="w-[300px] p-4 bg-background/90 backdrop-blur">
                ...
                <div className="absolute bottom-4 left-4 z-10">
                  <Card className="w-[250px] p-4 bg-background/90 backdrop-blur">
                    <div className="space-y-2">
                ...
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-7LXUmTixIprolP62fkQIy11VHBLvWA.png"
      ...
      {/* Order Service Section with gradient background */}
      <section id="order-service" className="relative bg-gradient-to-br from-primary/10 via-background to-background">
        <div className="container py-24">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <p className="max-w-[700px] text-muted-foreground md:text-xl">
              Visualize e gerencie todos os aspectos da ordem de serviço com métricas detalhadas e análises em tempo
              real.
            </p>
          </div>
          <div className="mt-16 relative">
            ...
            <div className="w-full bg-muted rounded-md overflow-hidden">
              <Image
                src="https://i.ibb.co/ksGXjWW1/image.png"
                alt="Time Analysis"
                width={800}
                height={800}
      ...
      <section className="border-y relative bg-gradient-to-r from-primary/20 via-primary/10 to-background">
        <div className="absolute inset-0 bg-grid-white/10" />
        <div className="container relative grid grid-cols-2 gap-8 py-12 md:grid-cols-4">
      ...
      <section id="dashboard" className="container py-24 md:py-32">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-2">
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <Image
              src="https://i.ibb.co/pvpX9xSp/image.png"
